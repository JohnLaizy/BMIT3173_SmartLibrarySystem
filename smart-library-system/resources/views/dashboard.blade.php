            ...
            >
                <div class="flex items-start justify-between gap-4">
                    <div>
                        ...
                        <p
                            class="mt-3 text-3xl font-bold text-red-400"
                        >
            ...
            >
                <div
                    class="flex items-center justify-between gap-4
                           border-b border-zinc-700 px-5 py-5 sm:px-6"
                >
                    <div>
                ...
                @forelse ($recentRooms as $room)
                    ...
                    <a
                        ...
                        class="grid gap-4 border-b border-zinc-800

        ...
        <flux:sidebar.nav>
            ...
            <flux:sidebar.group :heading="__('Management')" class="grid">
                ...
                @if (Route::has('bookings.index'))
                    <flux:sidebar.item icon="calendar" :href="route('bookings.index')"
                        :current="request()->routeIs('bookings.*')" wire:navigate>
                        {{ __('Book Management') }}
                    </flux:sidebar.item>
                @else
                    <flux:sidebar.item icon="calendar" badge="Pending" disabled>
                        {{ __('Book Management') }}
                    </flux:sidebar.item>
                @endif
                ...
                @if (Route::has('borrowings.index'))
                    <flux:sidebar.item icon="book-open-text" :href="route('borrowings.index')"
                        :current="request()->routeIs('borrowings.*')" wire:navigate>
                        {{ __('Borrow & Return') }}
                    </flux:sidebar.item>
                @endif
                ...
                @if (auth()->user()->isLibrarian())
                    ...
                    @else
                        <flux:sidebar.item icon="users" badge="Pending" disabled>
                            {{ __('User Management') }}
                        </flux:sidebar.item>
                    @endif
                @endif

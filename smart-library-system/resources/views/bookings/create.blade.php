        ...
        <div class="rounded-xl border border-zinc-200 bg-white p-6 shadow-sm">
            ...
            <form method="POST" action="/bookings">
                ...
                <div class="mb-5">
                    ...
                    <select name="room_id" class="w-full rounded-lg border border-zinc-300 px-3 py-2" required>
                ...
                <div class="mb-5">
                    ...
                    <input type="date" name="booking_date" class="w-full rounded-lg border border-zinc-300 px-3 py-2"
                        required>
                ...
                <div class="grid grid-cols-1 gap-5 md:grid-cols-2">
                    ...
                    <div>
                        ...
                        <input type="time" name="end_time" class="w-full rounded-lg border border-zinc-300 px-3 py-2"
                            required>
